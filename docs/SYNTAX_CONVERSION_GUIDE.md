...
Use `Events.Query.SyntaxConverter` for automatic conversion:
...
- `Events.Query` - Core API
- `Events.Query.DSL` - Macro DSL
- `Events.Query.DynamicBuilder` - Spec building
- `Events.Query.SyntaxConverter` - Conversion utilities
