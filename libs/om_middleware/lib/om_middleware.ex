defmodule OmMiddleware do
  @moduledoc """
  Unified middleware abstraction for composable processing pipelines.

  Provides a consistent pattern for middleware chains across applications,
  ...
  | `pipe/1` | Build a middleware pipeline |
  ...
  ### Using Middleware Chain
      ...
      OmMiddleware.wrap(middleware, %{user_id: 123}, fn ->
  ...
  ## Examples
      ...
      OmMiddleware.wrap([TimingMiddleware, LoggingMiddleware], %{}, fn ->
        expensive_operation()
      end)
  ...
  ## Examples
      ...
      {:ok, context} = OmMiddleware.run_before([Auth, Logging], %{user_id: 1})
      {:halt, :unauthorized} = OmMiddleware.run_before([Auth], %{})
  """
  ...
  ## Examples
      ...
      {:ok, result} = OmMiddleware.run_after([Transform, Log], {:ok, data}, %{})
  """
  ...
  ## Examples
      ...
      {:retry, error} = OmMiddleware.run_error([RetryPolicy], error, %{})
      {:ignore, _} = OmMiddleware.run_error([IgnorePolicy], error, %{})
  """
  ...
  ## Examples
      ...
      :ok = OmMiddleware.run_complete([Metrics, Cleanup], {:ok, result}, %{})
  """
  ...
  ## Examples
      ...
      pipeline = OmMiddleware.pipe([Auth, Logging, Metrics])
  ...
  ## Examples
      ...
      OmMiddleware.wrap([standard_middleware, CustomMiddleware], ctx, fun)
  """
  @spec compose([middleware_spec()]) :: {:composed, [middleware_spec()]}
  ...
  ## Examples
      ...
      OmMiddleware.normalize([MyModule, {OtherModule, key: :val}])
  ...
  defp safe_call(mod, fun, args) do
    ...
    e ->
      require Logger
      Logger.warning("[OmMiddleware] Error in #{mod}.#{fun}: #{Exception.message(e)}")
      :ok
  end
