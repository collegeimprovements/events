defmodule OmTypst do
  ...
  ## Examples
      ...
      {:ok, png} = OmTypst.compile("document.typ",
        format: :png,
        pages: "1-3",
        ppi: 300
      )
      ...
      {:ok, data} = OmTypst.query("document.typ", "<my-label>", field: :value)
  ...
  ## Examples
      ...
      # Basic compilation
      {:ok, pdf} = OmTypst.compile("report.typ")

      # High-quality PNG export
      {:ok, png} = OmTypst.compile("diagram.typ",
        format: :png,
        ppi: 300,
        pages: "1"
      )
      ...
      {:ok, pdf} = OmTypst.compile("thesis.typ",
        pdf_standard: :"a-2b",
  ...
  ## Examples
      ...
      {:ok, ["Chapter 1"]} = OmTypst.query("doc.typ", "<chapter-title>", field: :value)

      # Get first matching element
      {:ok, %{"level" => 1, "body" => ...}} = OmTypst.query("doc.typ", "heading", one: true)
  ...
  ## Examples
      ...
      {:ok, fonts} = OmTypst.fonts(font_path: "/path/to/custom/fonts")
  ...
  ## Examples
      ...
      # With custom name
      :ok = OmTypst.init("@preview/charged-ieee", name: "my-paper")

      # In a specific directory
      :ok = OmTypst.init("@preview/basic-resume", path: "/path/to/project")
