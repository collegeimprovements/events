defmodule OmMigration.FieldDefinitions do
  @moduledoc """
  ...
  ## Usage
      ...
      alias OmMigration.FieldDefinitions
  ...
  def audit_fields do
    [
      {OmFieldNames.created_by_urm_id(), @id_type, [null: true]},
      {OmFieldNames.updated_by_urm_id(), @id_type, [null: true]}
    ]
  end
  ...
  def audit_user_fields do
    [
      {OmFieldNames.created_by_user_id(), @id_type, [null: true]},
      {OmFieldNames.updated_by_user_id(), @id_type, [null: true]}
    ]
  end
  ...
  def ip_tracking_fields do
    [
      {OmFieldNames.created_from_ip(), @ip_type, [null: true]},
      {OmFieldNames.updated_from_ip(), @ip_type, [null: true]}
    ]
  end
  ...
  def session_tracking_fields do
    [
      {OmFieldNames.created_session_id(), @session_type, [null: true]},
      {OmFieldNames.updated_session_id(), @session_type, [null: true]}
    ]
  end
  ...
  def change_tracking_fields do
    [
      {OmFieldNames.change_history(), @json_type, [null: false, default: []]},
      {OmFieldNames.version(), @integer_type, [null: false, default: 1]}
    ]
  end
  ...
  def soft_delete_fields do
    [
      {OmFieldNames.deleted_at(), @timestamp_type, [null: true]},
      {OmFieldNames.deleted_by_urm_id(), @id_type, [null: true]}
    ]
  end
  ...
  def soft_delete_user_field do
    {OmFieldNames.deleted_by_user_id(), @id_type, [null: true]}
  end
  ...
  def soft_delete_reason_field do
    {OmFieldNames.deletion_reason(), @text_type, [null: true]}
  end
  ...
  def timestamp_fields do
    [
      {OmFieldNames.inserted_at(), @timestamp_type, [null: false]},
      {OmFieldNames.updated_at(), @timestamp_type, [null: false]}
    ]
  end
