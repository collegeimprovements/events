defmodule OmMigration.FieldMacros do
  @moduledoc """
  ...
  This module uses `OmMigration.FieldDefinitions` as the single source
  of truth for field types. For new projects, consider using the behavior-based
  FieldBuilders instead (e.g., `OmMigration.FieldBuilders.AuditFields`).
  """
