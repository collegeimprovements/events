defmodule OmSchema.Help do
  ...
  def list_topics do
    ...
    OmSchema.help(:general)    - Overview and philosophy
    OmSchema.help(:validators) - Available validators
    OmSchema.help(:pipelines)  - Pipeline patterns
    OmSchema.help(:patterns)   - Common patterns
    OmSchema.help(:examples)   - Complete examples
    """)
  end
