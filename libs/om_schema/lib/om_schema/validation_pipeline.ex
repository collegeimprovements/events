defmodule OmSchema.ValidationPipeline do
  @moduledoc """
  ...
  Uses `OmSchema.ValidatorRegistry` to look up validators for field types,
  ...
  def validate_field(changeset, field_name, field_type, opts) do
    ...
    if Application.get_env(@app_name, :validation_telemetry, false) do
      OmSchema.Telemetry.with_telemetry(changeset, field_name, field_type, opts, fn ->
