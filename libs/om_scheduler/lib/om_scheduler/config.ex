defmodule OmScheduler.Config do
  @moduledoc """
  ...
  @app_name Application.compile_env(:om_scheduler, :app_name, :om_scheduler)
  ...
  def schema do
    [
      ...
      peer: [
        ...
        - `OmScheduler.Peer.Postgres` - PostgreSQL advisory lock
        - `OmScheduler.Peer.Global` - Erlang :global (single node)
  ...
  @spec get() :: keyword()
  def get do
    Application.get_env(@app_name, OmScheduler, [])
  end
  ...
  def repo do
    get() |> Keyword.get(:repo)
  end

  @doc """
  Returns the configured repo module, raising if not configured.
  ...
  ## Examples
      ...
      iex> Config.repo!()
      ** (ArgumentError) No repo configured for OmScheduler
  """
  @spec repo!() :: module()
  def repo! do
    case repo() do
      nil -> raise ArgumentError, "No repo configured for OmScheduler. Set config :om_scheduler, repo: MyApp.Repo"
      repo -> repo
    end
  end
  ...
  ## Examples
      ...
      iex> Config.leader?(OmScheduler.Peer.Postgres)
  ...
  ## Examples
      ...
      OmScheduler.Store.Memory

      iex> Config.get_store_module(store: :database)
      OmScheduler.Store.Database
  """
  ...
  ## Examples
      ...
      :"OmScheduler.Queue.Producer.default"
  """
  ...
  defp default_peer_for_store(opts) do
    case Keyword.get(opts, :store) do
      :database -> OmScheduler.Peer.Postgres
      _ -> OmScheduler.Peer.Global
    end
  end
