defmodule OmScheduler.Cron.Expression do
  @moduledoc """
...
defimpl String.Chars, for: OmScheduler.Cron.Expression do
  def to_string(expr), do: OmScheduler.Cron.Expression.to_string(expr)
end
