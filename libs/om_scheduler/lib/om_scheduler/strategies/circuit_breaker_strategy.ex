defmodule OmScheduler.Strategies.CircuitBreakerStrategy do
  @moduledoc """
  ...
  - `OmScheduler.Strategies.CircuitBreaker.Default` - Standard three-state circuit breaker
  - `OmScheduler.Strategies.CircuitBreaker.Noop` - Pass-through (no circuit breaking)

  ## Configuration

      config :om_scheduler,
        circuit_breaker_strategy: OmScheduler.Strategies.CircuitBreaker.Default,
