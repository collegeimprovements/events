defmodule OmScheduler.Strategies.StrategyRunner do
  @moduledoc """
  ...
  ## Configuration
      ...
      config :om_scheduler,
        strategies: [
          circuit_breaker: OmScheduler.Strategies.CircuitBreaker.Default,
          rate_limiter: OmScheduler.Strategies.RateLimiter.TokenBucket,
          error_classifier: OmScheduler.Strategies.ErrorClassifier.Default
        ],
  ...
  defp init_circuit_breaker(strategies, conf) do
    module =
      Keyword.get(
        strategies,
        :circuit_breaker,
        OmScheduler.Strategies.CircuitBreaker.Default
      )
  ...
  defp init_rate_limiter(strategies, conf) do
    module =
      Keyword.get(
        strategies,
        :rate_limiter,
        OmScheduler.Strategies.RateLimiter.TokenBucket
      )
  ...
  defp init_error_classifier(strategies, conf) do
    module =
      Keyword.get(
        strategies,
        :error_classifier,
        OmScheduler.Strategies.ErrorClassifier.Default
      )
