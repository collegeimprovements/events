defmodule OmScheduler.Strategies.RateLimiterStrategy do
  @moduledoc """
  ...
  - `OmScheduler.Strategies.RateLimiter.TokenBucket` - Standard token bucket
  - `OmScheduler.Strategies.RateLimiter.SlidingWindow` - Sliding window counter
  - `OmScheduler.Strategies.RateLimiter.Noop` - Pass-through (no limiting)

  ## Configuration

      config :om_scheduler,
        rate_limiter_strategy: OmScheduler.Strategies.RateLimiter.TokenBucket,
        rate_limits: [
