defmodule OmScheduler.Strategies.ErrorClassifierStrategy do
  @moduledoc """
  ...
  - `OmScheduler.Strategies.ErrorClassifier.Default` - Pattern + protocol-based
  - `OmScheduler.Strategies.ErrorClassifier.Simple` - Simple retryable/terminal

  ## Configuration

      config :om_scheduler,
        error_classifier_strategy: OmScheduler.Strategies.ErrorClassifier.Default,
  ...
  ## Implementing a Custom Strategy
      ...
      defmodule MyApp.DomainErrorClassifier do
        @behaviour OmScheduler.Strategies.ErrorClassifierStrategy
