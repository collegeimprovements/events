defmodule OmScheduler.Workflow.Engine do
  @moduledoc """
  ...
  alias OmScheduler.Workflow.{Step, Execution, StateMachine, Registry, Store, Telemetry}
  ...
  defp via(execution_id) do
    {:via, Registry, {OmScheduler.Workflow.Registry, execution_id}}
  end
