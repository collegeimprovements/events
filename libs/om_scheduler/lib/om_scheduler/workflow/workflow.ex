defmodule OmScheduler.Workflow do
  @moduledoc """
  ...
  defmacro __using__(opts) do
    quote bind_quoted: [opts: opts] do
      ...
      @before_compile OmScheduler.Workflow
    end
  end
  ...
  defmacro __before_compile__(env) do
    ...
    quote do
      @doc false
      def __workflow__ do
        OmScheduler.Workflow.from_module(
          __MODULE__,
  ...
  def summary(workflow_name) do
    alias OmScheduler.Workflow.Introspection.Summary
  ...
  def to_mermaid(workflow_name, opts \\ []) do
    alias OmScheduler.Workflow.Introspection.Mermaid
  ...
  def to_dot(workflow_name, opts \\ []) do
    alias OmScheduler.Workflow.Introspection.Dot
  ...
  def to_table(workflow_name, opts \\ []) do
    alias OmScheduler.Workflow.Introspection.Table
