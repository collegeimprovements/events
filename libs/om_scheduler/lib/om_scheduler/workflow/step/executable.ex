defprotocol OmScheduler.Workflow.Step.Executable do
  @moduledoc """
...
defimpl OmScheduler.Workflow.Step.Executable, for: Function do
...
defimpl OmScheduler.Workflow.Step.Executable, for: Atom do
...
defimpl OmScheduler.Workflow.Step.Executable, for: Tuple do
