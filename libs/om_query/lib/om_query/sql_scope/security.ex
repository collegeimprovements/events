defmodule OmQuery.SqlScope.Security do
  @moduledoc """
  ...
  ## Examples
      ...
      ** (OmQuery.SqlScope.SecurityError) SQL injection detected
  """

  alias OmQuery.SqlScope.SecurityError
  ...
  ## Examples
      ...
      ** (OmQuery.SqlScope.SecurityError) Invalid identifier
  ...
  ## Examples
      ...
      ** (OmQuery.SqlScope.SecurityError) Invalid qualified identifier
  """
  ...
  ## Examples
      ...
      ** (OmQuery.SqlScope.SecurityError) Dangerous SQL fragment detected
  """
  ...
  ## Examples
      ...
      ** (OmQuery.SqlScope.SecurityError) Unknown option
  """
