defmodule OmCrud.Options do
  ...
  @doc """
  Merge schema-level CRUD defaults into options.

  Schema defaults come from `__crud_config__/0` generated by `use OmCrud.Schema`
  with the `crud_config` macro. Explicit options take precedence over schema defaults.

  ## Examples

      Options.with_schema_defaults(User, [timeout: 5000])
      # If User.__crud_config__() returns [preload: [:account], timeout: 30_000],
      # result is [preload: [:account], timeout: 5000]
  """
