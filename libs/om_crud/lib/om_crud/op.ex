defmodule OmCrud.Op do
  ...
  >
  > - `OmCrud.ChangesetBuilder` - For changeset building and resolution
  > - `OmCrud.Options` - For option extraction and validation
  ...
  **Deprecated**: Use `OmCrud.ChangesetBuilder.build/3` instead.
  """
  ...
  **Deprecated**: Use `OmCrud.ChangesetBuilder.resolve/3` instead.
  """
