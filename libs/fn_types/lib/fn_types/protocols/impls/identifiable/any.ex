defimpl FnTypes.Protocols.Identifiable, for: Any do
  @moduledoc """
  ...
  ## Examples
      ...
      @derive FnTypes.Protocols.Identifiable
      ...
      # Full options
      @derive {FnTypes.Protocols.Identifiable, type: :order, id_field: :order_id}
  ...
  For more control, implement the protocol directly:
      ...
      defimpl FnTypes.Protocols.Identifiable, for: MyApp.ExternalUser do
  ...
  defmacro __deriving__(module, _struct, opts) do
    ...
    quote do
      defimpl FnTypes.Protocols.Identifiable, for: unquote(module) do
        @impl true
