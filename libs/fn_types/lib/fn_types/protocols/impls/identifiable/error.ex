defimpl FnTypes.Protocols.Identifiable, for: FnTypes.Error do
  @moduledoc """
  Identifiable implementation for FnTypes.Error structs.
  ...
  """
  @impl true
  def entity_type(%FnTypes.Error{type: type}), do: type
  ...
  """
  @impl true
  def id(%FnTypes.Error{id: id}), do: id
  ...
  """
  @impl true
  def identity(%FnTypes.Error{type: type, id: id}) do
    {type, id}
  end
end
