if Code.ensure_loaded?(Ecto.Changeset) do
  defimpl FnTypes.Protocols.Identifiable, for: Ecto.Changeset do
    @moduledoc """
    ...
    def entity_type(%Ecto.Changeset{data: %{__struct__: module} = data}) do
      ...
      if identifiable_impl_for(module) do
        FnTypes.Protocols.Identifiable.entity_type(data)
      else
    ...
    defp identifiable_impl_for(module) do
      ...
      impl = FnTypes.Protocols.Identifiable.impl_for(struct(module, %{}))
      impl && impl != FnTypes.Protocols.Identifiable.Any
    rescue
