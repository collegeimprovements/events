...
if Code.ensure_loaded?(Ecto.MultipleResultsError) do
  defimpl FnTypes.Protocols.Normalizable, for: Ecto.MultipleResultsError do
    @moduledoc """
...
if Code.ensure_loaded?(Ecto.ConstraintError) do
  defimpl FnTypes.Protocols.Normalizable, for: Ecto.ConstraintError do
    @moduledoc """
...
if Code.ensure_loaded?(Ecto.QueryError) do
  defimpl FnTypes.Protocols.Normalizable, for: Ecto.QueryError do
    @moduledoc """
...
if Code.ensure_loaded?(Ecto.CastError) do
  defimpl FnTypes.Protocols.Normalizable, for: Ecto.CastError do
    @moduledoc """
...
if Code.ensure_loaded?(Ecto.InvalidChangesetError) do
  defimpl FnTypes.Protocols.Normalizable, for: Ecto.InvalidChangesetError do
    @moduledoc """
    ...
    def normalize(%Ecto.InvalidChangesetError{changeset: changeset} = _exception, opts) do
      ...
      FnTypes.Protocols.Normalizable.normalize(changeset, opts)
    end
  end
end
