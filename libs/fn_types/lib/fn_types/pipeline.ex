...
defimpl Inspect, for: FnTypes.Pipeline do
...
defimpl String.Chars, for: FnTypes.Pipeline do
  def to_string(pipeline), do: FnTypes.Pipeline.to_string(pipeline)
end
