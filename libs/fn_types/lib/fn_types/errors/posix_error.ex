defmodule FnTypes.Errors.PosixError do
  @moduledoc """
  ...
  ## Usage
      ...
      # Wrap a POSIX error
      error = FnTypes.Errors.PosixError.new(:enoent, path: "/path/to/file")
...
defimpl FnTypes.Protocols.Normalizable, for: FnTypes.Errors.PosixError do
  @moduledoc """
  ...
  def normalize(%FnTypes.Errors.PosixError{code: code, path: path, operation: operation}, opts) do
