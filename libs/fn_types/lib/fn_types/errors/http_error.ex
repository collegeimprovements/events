defmodule FnTypes.Errors.HttpError do
  @moduledoc """
  ...
  ## Usage
      ...
      error = FnTypes.Errors.HttpError.new(404)
...
defimpl FnTypes.Protocols.Normalizable, for: FnTypes.Errors.HttpError do
  @moduledoc """
  ...
  def normalize(%FnTypes.Errors.HttpError{status: status} = http_error, opts) do
  ...
  defp build_details(%FnTypes.Errors.HttpError{} = error) do
    %{
