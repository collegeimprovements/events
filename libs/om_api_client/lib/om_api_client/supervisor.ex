defmodule OmApiClient.Supervisor do
  @moduledoc """
  ...
  Add to your application supervision tree:
      ...
      children = [
        # Other children...
        {OmApiClient.Supervisor, clients: [
  ...
  Or start individual client supervisors:
      ...
      OmApiClient.Supervisor.start_link(name: :stripe, circuit_breaker: true, rate_limiter: true)
  ...
  For a single API client, use `OmApiClient.ClientSupervisor`:

      {OmApiClient.ClientSupervisor, name: :stripe}
  ...
  For runtime-created clients, use the registry-based approach:
      ...
      OmApiClient.Supervisor.start_client(:my_api, circuit_breaker: true)
      OmApiClient.Supervisor.stop_client(:my_api)
  """

  use Supervisor

  alias OmApiClient.Middleware.{CircuitBreaker, RateLimiter}
  ...
  - `:name` - Name for this supervisor (default: `OmApiClient.Supervisor`)
  ...
  ## Examples
      ...
      {OmApiClient.Supervisor, name: MyApp.APIClients, clients: [...]}
  """
  ...
  ## Examples
      ...
      OmApiClient.Supervisor.circuit_breaker_name(:stripe)
  ...
  ## Examples
      ...
      OmApiClient.Supervisor.rate_limiter_name(:stripe)
      #=> :stripe_rate_limiter
  """
  ...
  ## Examples
      ...
      OmApiClient.Supervisor.client_running?(:stripe)
      #=> true
  """
  ...
  ## Examples
      ...
      OmApiClient.Supervisor.client_status(:stripe)
      #=> %{
...
defmodule OmApiClient.ClientSupervisor do
  @moduledoc """
  ...
  ## Usage
      ...
      children = [
        {OmApiClient.ClientSupervisor, name: :stripe},
        {OmApiClient.ClientSupervisor, name: :github, circuit_breaker: [failure_threshold: 10]}
      ]
  ...
  alias OmApiClient.Middleware.{CircuitBreaker, RateLimiter}
  alias OmApiClient.Supervisor, as: APISupervisor
