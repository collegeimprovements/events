defmodule FnDecorator.Introspection do
  @moduledoc """
  ...
  Modules using `FnDecorator` automatically get introspection support
  ...
  generated in each decorated module by `FnDecorator`.
  """
  ...
  Returns `true` if the module was compiled with `use FnDecorator`.
