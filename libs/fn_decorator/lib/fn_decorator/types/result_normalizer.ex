defmodule FnDecorator.Types.ResultNormalizer do
  @moduledoc """
  ...
  def unwrap_result({:error, reason}, context) do
    raise FnDecorator.Types.UnwrapError,
      message: "Cannot unwrap {:error, _} in #{FnDecorator.Support.Context.full_name(context)}",
      reason: reason
  end
