defmodule FnDecorator.Types do
  @moduledoc """
  ...
  - `FnDecorator.Types.TypeChecker` - Type checking utilities
  - `FnDecorator.Types.Validators` - Validation functions
  - `FnDecorator.Types.ResultNormalizer` - Result normalization
  - `FnDecorator.Types.PipelineResult` - Pipeline-compatible wrapper
  - `FnDecorator.Types.TypeError` - Type mismatch exception
  - `FnDecorator.Types.UnwrapError` - Unwrap error exception
  """

  use FnDecorator.Define
  alias FnDecorator.SchemaFragments
  ...
  def returns_result(opts, body, context) do
    ...
    if validate do
      quote do
        ...
        FnDecorator.Types.Validators.validate_result_type(
          result,
          unquote(ok_type),
          unquote(error_type),
          unquote(strict),
    ...
    cond do
      validate ->
        quote do
          ...
          FnDecorator.Types.Validators.validate_maybe_type(
            result,
            unquote(type_spec),
            unquote(strict),
            unquote(context)
    ...
    quote do
      ...
      result =
        case unquote(on_error) do
          :unwrap ->
            FnDecorator.Types.ResultNormalizer.unwrap_result(result, unquote(context))
      ...
      if unquote(validate) do
        FnDecorator.Types.Validators.validate_bang_type(
          result,
          unquote(type_spec),
          unquote(strict),
          unquote(context)
  ...
  def returns_struct(opts, body, context) do
    ...
    if validate do
      quote do
        ...
        FnDecorator.Types.Validators.validate_struct_type(
          result,
  ...
  def returns_list(opts, body, context) do
    ...
    if validate do
      quote do
        ...
        FnDecorator.Types.Validators.validate_list_type(
          result,
  ...
  def returns_union(opts, body, context) do
    ...
    if validate do
      quote do
        ...
        FnDecorator.Types.Validators.validate_union_type(
          result,
          unquote(types),
          unquote(strict),
          unquote(context)
  ...
  def returns_pipeline(opts, body, context) do
    ...
    if enable_chain do
      quote do
        ...
        FnDecorator.Types.PipelineResult.new(result)
      end
    else
      if validate do
        quote do
  ...
  def normalize_result(opts, body, _context) do
    ...
    normalization_code =
      quote do
        FnDecorator.Types.ResultNormalizer.normalize_to_result(
          result,
