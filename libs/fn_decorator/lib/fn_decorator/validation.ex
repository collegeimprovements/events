defmodule FnDecorator.Validation do
  @moduledoc """
      ...
      case validation_result do
        ...
        {:error, errors} ->
          case unquote(on_error) do
            :raise ->
              raise FnDecorator.ValidationError,
          ...
          if target_type do
            case unquote(__MODULE__).coerce_value(arg, target_type) do
              ...
              {:error, _reason} ->
                case unquote(on_error) do
                  :raise ->
                    raise FnDecorator.CoercionError,
                      message:
  ...
  def handle_contract_violation(type, context, :raise) do
    raise FnDecorator.ContractViolationError,
...
defmodule FnDecorator.ValidationError do
  defexception [:message, :errors]
end

defmodule FnDecorator.CoercionError do
  defexception [:message]
end

defmodule FnDecorator.ContractViolationError do
  defexception [:message]
end
