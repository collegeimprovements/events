defmodule FnDecorator.Security do
  @moduledoc """
  ...
  @rate_limit_schema NimbleOptions.new!(
                       ...
                       backend: [
                         type: :atom,
                         default: FnDecorator.RateLimiter,
  ...
  def role_required(opts, body, _context) do
    ...
    quote do
      ...
      check_fn = unquote(check_fn) || (&FnDecorator.Security.default_role_check/2)
      ...
      if check_fn.(user, unquote(roles)) do
        ...
        case unquote(on_error) do
          :raise ->
            raise FnDecorator.UnauthorizedError,
    ...
    quote do
      ...
      case unquote(backend).check_rate(key, unquote(max), window_ms) do
        ...
        {:error, :rate_limited} ->
          case unquote(on_error) do
            :raise ->
              raise FnDecorator.RateLimitError,
...
defmodule FnDecorator.UnauthorizedError do
  defexception [:message]
end

defmodule FnDecorator.RateLimitError do
  defexception [:message]
end
