defmodule FnTypes.Protocols.IdentifiableTest do
  ...
  # =============================================================================
  # Protocol Tests - FnTypes.Error Implementation
  # =============================================================================

  describe "FnTypes.Error implementation" do
    ...
    test "entity_type/1 varies by error type" do
      validation_error = FnTypes.Error.new(:validation, :invalid)
      not_found_error = FnTypes.Error.new(:not_found, :missing)
    ...
    test "different errors have different identities" do
      error1 = FnTypes.Error.new(:validation, :invalid_email)
      error2 = FnTypes.Error.new(:validation, :invalid_email)
  ...
  describe "Helpers.cache_key/2 with errors" do
    test "generates error type:id format" do
      error = FnTypes.Error.new(:validation, :invalid)
  ...
  describe "Helpers.same_entity?/2" do
    ...
    test "returns false for different error types (different types)" do
      error1 = FnTypes.Error.new(:validation, :invalid)
      error2 = FnTypes.Error.new(:not_found, :missing)
  ...
  describe "Helpers.group_by_type/1 with errors" do
    test "groups errors by their type" do
      val_error1 = FnTypes.Error.new(:validation, :invalid)
      val_error2 = FnTypes.Error.new(:validation, :required)
      not_found = FnTypes.Error.new(:not_found, :missing)
