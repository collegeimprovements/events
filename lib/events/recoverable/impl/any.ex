defimpl Events.Recoverable, for: Any do
  @moduledoc """
  ...
  For more control, implement the protocol directly:
      ...
      defimpl Events.Recoverable, for: MyApp.APIError do
  ...
  defmacro __deriving__(module, _struct, opts) do
    ...
    quote do
      defimpl Events.Recoverable, for: unquote(module) do
        alias Events.Recoverable.Backoff
