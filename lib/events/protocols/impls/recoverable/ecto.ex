...
if Code.ensure_loaded?(Ecto.StaleEntryError) do
  defimpl Events.Protocols.Recoverable, for: Ecto.StaleEntryError do
    @moduledoc """
...
if Code.ensure_loaded?(Ecto.NoResultsError) do
  defimpl Events.Protocols.Recoverable, for: Ecto.NoResultsError do
    @moduledoc """
...
if Code.ensure_loaded?(Ecto.MultipleResultsError) do
  defimpl Events.Protocols.Recoverable, for: Ecto.MultipleResultsError do
    @moduledoc """
...
if Code.ensure_loaded?(Ecto.ConstraintError) do
  defimpl Events.Protocols.Recoverable, for: Ecto.ConstraintError do
    @moduledoc """
...
if Code.ensure_loaded?(Ecto.InvalidChangesetError) do
  defimpl Events.Protocols.Recoverable, for: Ecto.InvalidChangesetError do
    @moduledoc """
...
if Code.ensure_loaded?(Ecto.Query.CastError) do
  defimpl Events.Protocols.Recoverable, for: Ecto.Query.CastError do
    @moduledoc """
...
if Code.ensure_loaded?(Ecto.QueryError) do
  defimpl Events.Protocols.Recoverable, for: Ecto.QueryError do
    @moduledoc """
