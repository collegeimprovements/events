defimpl Events.Protocols.Recoverable, for: Any do
  @moduledoc """
  ...
  You can derive Recoverable for your custom error structs:
      ...
      defmodule MyApp.CustomError do
        @derive {Events.Protocols.Recoverable,
          recoverable: true,
  ...
  For more control, implement the protocol directly:
      ...
      defimpl Events.Protocols.Recoverable, for: MyApp.APIError do
  ...
  defmacro __deriving__(module, _struct, opts) do
    ...
    quote do
      defimpl Events.Protocols.Recoverable, for: unquote(module) do
        alias Events.Protocols.Recoverable.Backoff
