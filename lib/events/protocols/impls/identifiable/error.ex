defimpl Events.Protocols.Identifiable, for: Events.Types.Error do
  @moduledoc """
  Identifiable implementation for Events.Types.Error structs.
  ...
  """
  @impl true
  def entity_type(%Events.Types.Error{type: type}), do: type
  ...
  """
  @impl true
  def id(%Events.Types.Error{id: id}), do: id
  ...
  """
  @impl true
  def identity(%Events.Types.Error{type: type, id: id}) do
    {type, id}
  end
end
