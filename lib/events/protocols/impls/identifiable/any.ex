defimpl Events.Protocols.Identifiable, for: Any do
  @moduledoc """
  ...
  ## Examples
      ...
      @derive Events.Protocols.Identifiable
      ...
      # Full options
      @derive {Events.Protocols.Identifiable, type: :order, id_field: :order_id}
  ...
  For more control, implement the protocol directly:
      ...
      defimpl Events.Protocols.Identifiable, for: MyApp.ExternalUser do
  ...
  defmacro __deriving__(module, _struct, opts) do
    ...
    quote do
      defimpl Events.Protocols.Identifiable, for: unquote(module) do
        @impl true
