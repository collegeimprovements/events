defmodule Events.Extensions.Decorator do
  ...
  - **`use Events.Extensions.Decorator`** - When you need Events-specific decorators

  ## Events-Specific Decorators

  These decorators are ONLY available via `use Events.Extensions.Decorator`:

  - `@decorate log_query(opts)` - Log database queries (uses Events.Data.Repo)
  ...
  Decorators can be configured in your application config:
      ...
      config :events, Events.Extensions.Decorator,
        telemetry_enabled: true,
        default_cache: Events.Data.Cache,
        log_level: :info
  ...
  When you `use Events.Extensions.Decorator`, it:
  ...
  defmacro __using__(_opts) do
    quote do
      use Events.Extensions.Decorator.Define
