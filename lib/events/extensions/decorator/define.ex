defmodule Events.Extensions.Decorator.Define do
  @moduledoc """
  ...
  # Events-specific telemetry (use Events.Data.Repo, Events.TaskSupervisor)
  defdelegate log_query(opts, body, context), to: Events.Extensions.Decorator.Telemetry
  defdelegate log_remote(opts, body, context), to: Events.Extensions.Decorator.Telemetry
