defmodule Events.Query.Debug do
  @moduledoc """
  ...
  - `:repo` - Repo module for SQL generation (default: inferred or Events.Repo)
  ...
  defp get_repo(opts) do
    opts[:repo] || Application.get_env(:events, :repo) || Events.Repo
  end
  ...
  defp find_caller_location(stack) do
    ...
    |> Enum.find(fn {mod, _fun, _arity, _loc} ->
      ...
      not String.starts_with?(mod_string, "Events.Query.Debug") and
        not String.starts_with?(mod_string, "Elixir.Events.Query.Debug") and
