defprotocol Events.Types.Recoverable do
  ...
  Each error type declares its own recovery strategy:
      ...
      defimpl Events.Types.Recoverable, for: MyApp.PaymentError do
  ...
  ## Implementing for Custom Errors
      ...
      defimpl Events.Types.Recoverable, for: MyApp.ExternalAPIError do
