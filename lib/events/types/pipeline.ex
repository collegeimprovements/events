defmodule Events.Types.Pipeline do
  @moduledoc """
  ...
  alias Events.Types.{Result, AsyncResult}
...
defimpl Inspect, for: Events.Types.Pipeline do
...
defimpl String.Chars, for: Events.Types.Pipeline do
  def to_string(pipeline), do: Events.Types.Pipeline.to_string(pipeline)
end
