defmodule Events.Migration.TokenValidator do
  @moduledoc """
  ...
  Raises `Events.Migration.ValidationError` with detailed error information.
  ...
  def validate!(%Token{} = token) do
    case validate(token) do
      ...
      {:error, errors} ->
        ...
        raise Events.Migration.ValidationError, message: message, errors: errors
    end
  end
...
defmodule Events.Migration.ValidationError do
  @moduledoc """
