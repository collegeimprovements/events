defmodule Events.Migration.Help do
  @moduledoc """
  ...
  def list_topics do
    ...
    Events.Migration.help(:general)   - Overview and philosophy
    Events.Migration.help(:pipeline)  - Pipeline functions
    Events.Migration.help(:fields)    - Field helpers
    Events.Migration.help(:indexes)   - Index creation
    Events.Migration.help(:dsl)       - DSL syntax
    Events.Migration.help(:examples)  - Complete examples
    Events.Migration.help(:patterns)  - Common patterns
    """)
  end
  ...
  def general_help do
    ...
    1. Add `use Events.Migration` to your migration module
    2. Choose pipeline or DSL style
    3. Compose your migration using available functions
    4. Execute the migration

    For more help: Events.Migration.help(:examples)
    """)
  end
