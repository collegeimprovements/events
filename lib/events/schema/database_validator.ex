defmodule Events.Schema.DatabaseValidator do
  @moduledoc """
  ...
  ### Programmatic
      ...
      alias Events.Schema.DatabaseValidator
  ...
  @doc """
  Validates all schemas that use `Events.Schema`.

  Discovers all modules that have the `__constraints__/0` function
  (indicating they use Events.Schema with constraint support).
  ...
  @doc """
  Discovers all schema modules that use Events.Schema.
