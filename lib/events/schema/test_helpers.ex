defmodule Events.Schema.TestHelpers do
  @moduledoc """
  Test helpers for Events.Schema validation testing.
  ...
  def test_normalization(value, opts) when is_list(opts) do
    Events.Schema.Helpers.Normalizer.normalize(value, opts)
  end

  def test_normalization(value, normalizer) do
    # Wrap non-list normalizers in opts format
    Events.Schema.Helpers.Normalizer.normalize(value, normalize: normalizer)
  end
