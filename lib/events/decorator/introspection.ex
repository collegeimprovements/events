defmodule Events.Decorator.Introspection do
  @moduledoc """
  ...
  Modules using `Events.Decorator` automatically get introspection support
  ...
  generated in each decorated module by `Events.Decorator`.
  """
  ...
  Returns `true` if the module was compiled with `use Events.Decorator`.
