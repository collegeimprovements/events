defmodule Events.Infra.Scheduler.Store.Behaviour do
  @moduledoc """
  ...
  - `Events.Infra.Scheduler.Store.Memory` - ETS-based, for development
  - `Events.Infra.Scheduler.Store.Database` - PostgreSQL-based, for production
  """
