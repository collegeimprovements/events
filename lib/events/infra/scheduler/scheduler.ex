defmodule Events.Infra.Scheduler do
  ...
  Use `Events.Infra.Scheduler.Worker` for complex jobs:
  ...
  alias Events.Infra.Scheduler.{Config, Job, Execution}
  alias Events.Infra.Scheduler.Queue.Producer
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      @before_compile Events.Infra.Scheduler.Decorator.Scheduled
    end
  end
  ...
  def queue_stats do
    Events.Infra.Scheduler.Queue.Supervisor.all_stats()
  end
