defmodule Events.Infra.Scheduler.Batch do
  @moduledoc """
  ...
  Define a batch job by implementing the `Events.Infra.Scheduler.Batch.Worker` behaviour:
  ...
  alias Events.Infra.Scheduler.{Job, Telemetry}
...
defmodule Events.Infra.Scheduler.Batch.Worker do
  @moduledoc """
  ...
  alias Events.Infra.Scheduler.Batch
  ...
  defmacro __using__(_opts) do
    quote do
      @behaviour Events.Infra.Scheduler.Batch.Worker

      alias Events.Infra.Scheduler.{Job, Batch}
