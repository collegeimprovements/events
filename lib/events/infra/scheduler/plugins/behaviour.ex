defmodule Events.Infra.Scheduler.Plugin do
  @moduledoc """
  ...
  - `Events.Infra.Scheduler.Plugins.Cron` - Schedules due jobs
  - `Events.Infra.Scheduler.Plugins.Pruner` - Cleans up old executions
  """
