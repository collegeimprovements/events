defmodule Events.Infra.Scheduler.Workflow.Step.Worker do
  @moduledoc """
  ...
  ## Usage
      ...
      defmodule MyApp.Steps.SendWelcomeEmail do
        use Events.Infra.Scheduler.Workflow.Step.Worker
  ...
  Worker modules can be used directly in workflows:
      ...
      defmodule MyApp.OnboardingWorkflow do
        use Events.Infra.Scheduler.Workflow, name: :onboarding
  ...
  defmacro __using__(_opts) do
    quote do
      @behaviour Events.Infra.Scheduler.Workflow.Step.Behaviour

      @impl Events.Infra.Scheduler.Workflow.Step.Behaviour
