defmodule Events.Infra.Decorator.Types.ResultNormalizer do
  @moduledoc """
  ...
  def unwrap_result({:error, reason}, context) do
    raise Events.Infra.Decorator.Types.UnwrapError,
      message: "Cannot unwrap {:error, _} in #{Events.Support.Context.full_name(context)}",
      reason: reason
  end
