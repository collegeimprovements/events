defmodule Events.Infra.Decorator.Pipeline do
  @moduledoc """
  ...
  defp apply_decorator({decorator_name, opts}, body, context) when is_atom(decorator_name) do
    case Events.Infra.Decorator.Registry.get(decorator_name) do
      nil ->
        raise ArgumentError,
              "Unknown decorator #{inspect(decorator_name)} in compose/1. " <>
                "Register it with Events.Infra.Decorator.Registry.register/3 or check spelling."
