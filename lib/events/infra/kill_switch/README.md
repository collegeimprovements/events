...
```elixir
alias Events.Infra.KillSwitch.S3, as: S3KS
...
```elixir
alias Events.Infra.KillSwitch.Cache, as: CacheKS
...
defmodule MyApp.FileUploader do
  alias Events.Infra.KillSwitch.S3
...
Process.whereis(Events.Infra.KillSwitch)
#=> #PID<0.XXX.0> or nil
