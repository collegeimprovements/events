defmodule Events.StartupChecker do
  @moduledoc """
  Thin wrapper around `Events.SystemHealth` for boot-time diagnostics.
  ...
  Delegates to `Events.SystemHealth.services_status/0`.
  """
  ...
  Accepts the same options as `Events.SystemHealth.display/1`.
  """
