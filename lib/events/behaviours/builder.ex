defmodule Events.Behaviours.Builder do
  @moduledoc """
  ...
  ## Example
      ...
      defmodule MyApp.Builders.UserValidation do
        @behaviour Events.Behaviours.Builder
  ...
  defmacro __using__(_opts) do
    quote do
      @behaviour Events.Behaviours.Builder
      import Events.Behaviours.Builder, only: [defcompose: 2]
    end
  end
end