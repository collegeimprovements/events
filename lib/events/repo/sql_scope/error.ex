defmodule Events.Repo.SqlScope.Error do
  @moduledoc """
  ...
  ## Examples
      ...
      ** (Events.Repo.SqlScope.Error) Table 'products' not found

      iex> raise SqlScope.Error,
      ...>   reason: :permission_denied,
      ...>   query: "SELECT * FROM pg_indexes"
      ** (Events.Repo.SqlScope.Error) Permission denied
  """
...
defmodule Events.Repo.SqlScope.SecurityError do
  @moduledoc """
