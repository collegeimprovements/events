defimpl Events.Identifiable, for: Ecto.Changeset do
  @moduledoc """
  ...
  def entity_type(%Ecto.Changeset{data: %{__struct__: module} = data}) do
    ...
    if identifiable_impl_for(module) do
      Events.Identifiable.entity_type(data)
    else
  ...
  defp identifiable_impl_for(module) do
    ...
    impl = Events.Identifiable.impl_for(struct(module, %{}))
    impl && impl != Events.Identifiable.Any
  rescue
