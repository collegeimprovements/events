defmodule Events.Migration do
  ...
  Run `Events.Migration.help()` for available commands and patterns.
  """

  alias Events.Migration.{Token, Help, Executor}

  defmacro __using__(_opts) do
    quote do
      use Ecto.Migration
      import Events.Migration
      import Events.Migration.Pipeline
      # Don't import timestamps - use Ecto's version
      import Events.Migration.DSLEnhanced, except: [timestamps: 0, timestamps: 1]
    end
  end
  ...
  ## Examples
      ...
      Events.Migration.help()           # General help
      Events.Migration.help(:fields)    # Field helpers
      Events.Migration.help(:indexes)   # Index helpers
