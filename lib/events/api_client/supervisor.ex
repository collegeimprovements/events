defmodule Events.APIClient.Supervisor do
  @moduledoc """
  ...
  Add to your application supervision tree:
      ...
      children = [
        # Other children...
        {Events.APIClient.Supervisor, clients: [
  ...
  Or start individual client supervisors:
      ...
      Events.APIClient.Supervisor.start_link(name: :stripe, circuit_breaker: true, rate_limiter: true)
  ...
  For a single API client, use `Events.APIClient.ClientSupervisor`:

      {Events.APIClient.ClientSupervisor, name: :stripe}
  ...
  For runtime-created clients, use the registry-based approach:
      ...
      Events.APIClient.Supervisor.start_client(:my_api, circuit_breaker: true)
      Events.APIClient.Supervisor.stop_client(:my_api)
  """

  use Supervisor

  alias Events.APIClient.Middleware.{CircuitBreaker, RateLimiter}
  ...
  - `:name` - Name for this supervisor (default: `Events.APIClient.Supervisor`)
  ...
  ## Examples
      ...
      {Events.APIClient.Supervisor, name: MyApp.APIClients, clients: [...]}
  """
  ...
  ## Examples
      ...
      Events.APIClient.Supervisor.circuit_breaker_name(:stripe)
  ...
  ## Examples
      ...
      Events.APIClient.Supervisor.rate_limiter_name(:stripe)
      #=> :stripe_rate_limiter
  """
  ...
  ## Examples
      ...
      Events.APIClient.Supervisor.client_running?(:stripe)
      #=> true
  """
  ...
  ## Examples
      ...
      Events.APIClient.Supervisor.client_status(:stripe)
      #=> %{
...
defmodule Events.APIClient.ClientSupervisor do
  @moduledoc """
  ...
  ## Usage
      ...
      children = [
        {Events.APIClient.ClientSupervisor, name: :stripe},
        {Events.APIClient.ClientSupervisor, name: :github, circuit_breaker: [failure_threshold: 10]}
      ]
  ...
  ## Example with Custom Options
      ...
      {Events.APIClient.ClientSupervisor,
        name: :stripe,
  ...
  alias Events.APIClient.Middleware.{CircuitBreaker, RateLimiter}
  alias Events.APIClient.Supervisor, as: APISupervisor
