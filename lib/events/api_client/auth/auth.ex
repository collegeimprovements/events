defprotocol Events.APIClient.Auth do
  ...
  - `Events.APIClient.Auth.APIKey` - API key in header or query
  - `Events.APIClient.Auth.Basic` - HTTP Basic authentication
  - `Events.APIClient.Auth.OAuth2` - OAuth2 bearer tokens with refresh
  - `Events.APIClient.Auth.Bearer` - Simple bearer token
