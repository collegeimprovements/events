defmodule Events.APIClient.Telemetry do
  @moduledoc """
  ...
  Attach handlers in your application startup:
      ...
      def start(_type, _args) do
        Events.APIClient.Telemetry.attach_default_handlers()
        # ...
      end
  ...
  The events are compatible with OpenTelemetry. Use the span helpers:
      ...
      Events.APIClient.Telemetry.span(:stripe, fn ->
  ...
  Enable request logging:
      ...
      Events.APIClient.Telemetry.attach_logger()
