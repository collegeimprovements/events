defmodule Events.Support.Context do
  ...
  ## Examples
      ...
      iex> context = %Events.Support.Context{module: MyApp.User, name: :create, arity: 2}
      iex> Events.Support.Context.full_name(context)
      "MyApp.User.create/2"
  """
  ...
  ## Examples
      ...
      iex> context = %Events.Support.Context{module: MyApp.Services.UserService, name: :create, arity: 1}
      iex> Events.Support.Context.short_module(context)
      "UserService"
  """
  ...
  ## Examples
      ...
      iex> Events.Support.Context.telemetry_module(context)
      :user_service
  """
  ...
  ## Examples
      ...
      iex> Events.Support.Context.telemetry_event(context, [:myapp])
  ...
  ## Examples
      ...
      iex> context = %Events.Support.Context{module: MyApp.UserService, name: :create, arity: 1}
      iex> Events.Support.Context.span_name(context)
      "user_service.create"
  """
  ...
  ## Examples
      ...
      iex> context = %Events.Support.Context{args: [{:user_id, [], nil}, {:name, [], nil}]}
      iex> Events.Support.Context.arg_names(context)
      [:user_id, :name]
  """
  ...
  ## Examples
      ...
      iex> context = %Events.Support.Context{module: MyApp.User, name: :create, arity: 2}
      iex> Events.Support.Context.base_metadata(context)
      %{module: MyApp.User, function: :create, arity: 2}

      iex> Events.Support.Context.base_metadata(context, timestamp: true, node: true)
