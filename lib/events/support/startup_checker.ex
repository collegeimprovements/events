defmodule Events.Support.StartupChecker do
  @moduledoc """
  Thin wrapper around `Events.Infra.SystemHealth` for boot-time diagnostics.
  ...
  Delegates to `Events.Infra.SystemHealth.services_status/0`.
  """
  ...
  Accepts the same options as `Events.Infra.SystemHealth.display/1`.
  """
