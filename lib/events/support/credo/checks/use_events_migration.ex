defmodule Events.Support.Credo.Checks.UseEventsMigration do
  @moduledoc """
  Checks that all migrations use `Events.Core.Migration` instead of raw `Ecto.Migration`.

  This ensures consistency across the codebase and leverages our enhanced migration features.

  ## Why This Matters

  `Events.Core.Migration` provides:
  ...
  Incorrect:
      ...
      defmodule MyApp.Repo.Migrations.CreateUsers do
        use Ecto.Migration  # Bad - use Events.Core.Migration instead
      end
  ...
  use Credo.Check,
    ...
    explanations: [
      check: """
      Always use `Events.Core.Migration` instead of `Ecto.Migration` in migration files.

      Events.Core.Migration wraps Ecto.Migration and provides pipeline-based table
  ...
  defp issue_for(issue_meta, line_no, trigger) do
    format_issue(
      issue_meta,
      message: "Use `Events.Core.Migration` instead of `Ecto.Migration` for consistency.",
      trigger: trigger,
      line_no: line_no
    )
  end
