defmodule Events.Core.Query.Validator do
  @moduledoc false
  ...
  alias Events.Core.Query.ValidationError
  ...
  def validate_filter_value(:in_subquery, %Events.Core.Query.Token{}), do: :ok
  ...
  def validate_filter_value(:not_in_subquery, %Events.Core.Query.Token{}), do: :ok
