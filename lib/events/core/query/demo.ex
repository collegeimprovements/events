defmodule Events.Core.Query.Demo do
  @moduledoc false
  ...
  #
  # Quick Start:
  #   iex> Events.Core.Query.Demo.token_composition()
  #   iex> Events.Core.Query.Demo.token_inspection()
  #   iex> Events.Core.Query.Demo.result_structure()
