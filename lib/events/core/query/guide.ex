defmodule Events.Core.Query.Guide do
  @moduledoc false
  # Reference guide module - not part of public API.
  # This module contains comprehensive documentation for Events.Core.Query.
  # The content below is kept as a large @doc for reference purposes.

  @doc ~S"""
  # Events.Core.Query - Comprehensive Reference Guide
  ...
  ```elixir
  alias Events.Core.Query.Fragment
