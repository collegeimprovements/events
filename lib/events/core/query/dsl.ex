defmodule Events.Core.Query.DSL do
  @moduledoc """
  ...
  defmacro query(source, do: block) do
    quote do
      var!(query_token, Events.Core.Query.DSL) = Events.Core.Query.new(unquote(source))
      unquote(block)
  ...
  defmacro where(filters) when is_list(filters) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.filter(var!(query_token, Events.Core.Query.DSL), unquote(filters))
    end
  end
  ...
  defmacro filters(filter_list) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.filters(var!(query_token, Events.Core.Query.DSL), unquote(filter_list))
    end
  end
  ...
  defmacro orders(order_list) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.orders(var!(query_token, Events.Core.Query.DSL), unquote(order_list))
    end
  end
  ...
  defmacro limit(n) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.limit(var!(query_token, Events.Core.Query.DSL), unquote(n))
    end
  end
  ...
  defmacro offset(n) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.offset(var!(query_token, Events.Core.Query.DSL), unquote(n))
    end
  end
  ...
  defmacro select(fields) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.select(var!(query_token, Events.Core.Query.DSL), unquote(fields))
    end
  end
  ...
  defmacro preload(assoc) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.preload(var!(query_token, Events.Core.Query.DSL), unquote(assoc))
    end
  end
  ...
  defmacro preload(assoc, do: block) do
    quote do
      ...
      outer_token = var!(query_token, Events.Core.Query.DSL)

      # Build preload with a function that creates the nested query
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.preload(outer_token, unquote(assoc), fn _nested ->
          # Create a fresh nested token and execute the block
          inner_token = Events.Core.Query.new(:nested)
          var!(query_token, Events.Core.Query.DSL) = inner_token
          unquote(block)
          var!(query_token, Events.Core.Query.DSL)
        end)
    end
  ...
  defmacro distinct(value \\ true) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.distinct(var!(query_token, Events.Core.Query.DSL), unquote(value))
    end
  end
  ...
  defmacro group_by(fields) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.group_by(var!(query_token, Events.Core.Query.DSL), unquote(fields))
    end
  end
  ...
  defmacro having(conditions) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.having(var!(query_token, Events.Core.Query.DSL), unquote(conditions))
    end
  end
  ...
  defmacro with_cte(name, do: block) do
    quote do
      ...
      cte_token = Events.Core.Query.new(:nested)
      var!(query_token, Events.Core.Query.DSL) = cte_token
      unquote(block)
      cte_result = var!(query_token, Events.Core.Query.DSL)

      # Add CTE to the outer token
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.with_cte(outer_token, unquote(name), cte_result)
    end
  end
  ...
  defmacro any_of(filters) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.where_any(var!(query_token, Events.Core.Query.DSL), unquote(filters))
    end
  end
  ...
  defmacro all_of(filters) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.where_all(var!(query_token, Events.Core.Query.DSL), unquote(filters))
    end
  end
  ...
  defmacro none_of(filters) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.where_none(var!(query_token, Events.Core.Query.DSL), unquote(filters))
    end
  end
  ...
  defmacro contains_string(field, substring) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.contains_string(
          var!(query_token, Events.Core.Query.DSL),
          unquote(field),
          unquote(substring)
        )
  ...
  defmacro null(field) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.where_nil(var!(query_token, Events.Core.Query.DSL), unquote(field))
    end
  end
  ...
  defmacro not_null(field) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.where_not_nil(var!(query_token, Events.Core.Query.DSL), unquote(field))
    end
  end
  ...
  defmacro not_null(field, opts) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.where_not_nil(
          var!(query_token, Events.Core.Query.DSL),
          unquote(field),
          unquote(opts)
        )
  ...
  defmacro blank(field) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.where_blank(var!(query_token, Events.Core.Query.DSL), unquote(field))
    end
  end
  ...
  defmacro present(field) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.where_present(var!(query_token, Events.Core.Query.DSL), unquote(field))
    end
  end
  ...
  defmacro present(field, opts) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.where_present(
          var!(query_token, Events.Core.Query.DSL),
          unquote(field),
          unquote(opts)
        )
  ...
  defmacro scope(scope_fn) do
    quote do
      var!(query_token, Events.Core.Query.DSL) =
        Events.Core.Query.scope(var!(query_token, Events.Core.Query.DSL), unquote(scope_fn))
    end
  end
