defmodule Events.Core.Query.Multi do
  @moduledoc """
  ...
  ## Examples
      ...
      |> QM.query(:user_posts, fn %{active_users: users} ->
        ...
        Post
        |> Events.Core.Query.new()
        |> Events.Core.Query.filter(:user_id, :in, user_ids)
      end)
      |> Events.Core.Repo.transaction()
  """

  alias Events.Core.Query.{Token, Executor}
  alias Ecto.Multi
  ...
  ## Examples
      ...
      Multi.new()
      |> Events.Core.Query.Multi.query(:users, user_token)

      Multi.new()
      |> Events.Core.Query.Multi.query(:users, fn _ -> build_user_query() end)
  """
  ...
  ## Examples
      ...
      Multi.new()
      |> Events.Core.Query.Multi.queries(%{
        users: user_token,
        posts: post_token,
  ...
  ## Examples
      ...
      Multi.new()
      |> Events.Core.Query.Multi.query_data(:users, user_token)
  ...
  ## Examples
      ...
      Multi.new()
      |> Events.Core.Query.Multi.query_one(:user, user_token)
  """
