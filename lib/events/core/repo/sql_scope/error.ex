defmodule Events.Core.Repo.SqlScope.Error do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> raise SqlScope.Error, reason: :table_not_found, table: :products
      ** (Events.Core.Repo.SqlScope.Error) Table 'products' not found

      iex> raise SqlScope.Error,
      ...>   reason: :permission_denied,
      ...>   query: "SELECT * FROM pg_indexes"
      ** (Events.Core.Repo.SqlScope.Error) Permission denied
  """
...
defmodule Events.Core.Repo.SqlScope.SecurityError do
  @moduledoc """
