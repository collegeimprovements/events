defmodule Events.Core.Repo.SqlScope.Security do
  @moduledoc """
  ...
  ## Examples
      ...
      ** (Events.Core.Repo.SqlScope.SecurityError) SQL injection detected
  """

  alias Events.Core.Repo.SqlScope.SecurityError
  ...
  ## Examples
      ...
      ** (Events.Core.Repo.SqlScope.SecurityError) Invalid identifier
  ...
  ## Examples
      ...
      ** (Events.Core.Repo.SqlScope.SecurityError) Invalid qualified identifier
  """
  ...
  ## Examples
      ...
      ** (Events.Core.Repo.SqlScope.SecurityError) Dangerous SQL fragment detected
  """
  ...
  ## Examples
      ...
      ** (Events.Core.Repo.SqlScope.SecurityError) Unknown option
  """
