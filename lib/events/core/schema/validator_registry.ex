defmodule Events.Core.Schema.ValidatorRegistry do
  @moduledoc """
  ...
  |------------|------------------|
  | `:string`, `:citext` | `Events.Core.Schema.Validators.String` |
  | `:integer`, `:float`, `:decimal` | `Events.Core.Schema.Validators.Number` |
  | `:boolean` | `Events.Core.Schema.Validators.Boolean` |
  | `{:array, _}` | `Events.Core.Schema.Validators.Array` |
  | `:map` | `Events.Core.Schema.Validators.Map` |
  | `:utc_datetime`, `:utc_datetime_usec`, `:date`, `:naive_datetime` | `Events.Core.Schema.Validators.DateTime` |
  ...
  ## Usage
      ...
      validator = Events.Core.Schema.ValidatorRegistry.get(:string)
  ...
  ## Examples
      ...
      iex> Events.Core.Schema.ValidatorRegistry.get(:string)
      Events.Core.Schema.Validators.String

      iex> Events.Core.Schema.ValidatorRegistry.get(:unknown_type)
      nil

      iex> Events.Core.Schema.ValidatorRegistry.get({:array, :string})
      Events.Core.Schema.Validators.Array
  """
  ...
  The validator module must implement `Events.Core.Schema.Behaviours.Validator`.
  ...
  def register(field_type, validator_module)
    ...
    case Process.whereis(__MODULE__) do
      nil ->
        raise RuntimeError,
              "ValidatorRegistry not started. Add Events.Core.Schema.ValidatorRegistry to your supervision tree."
  ...
  ## Examples
      ...
      Events.Core.Schema.ValidatorRegistry.unregister(:custom_type)
  """
  ...
  ## Examples
      ...
      iex> Events.Core.Schema.ValidatorRegistry.all()
      %{
        string: Events.Core.Schema.Validators.String,
        integer: Events.Core.Schema.Validators.Number,
        ...
      }
  """
  ...
  ## Examples
      ...
      iex> Events.Core.Schema.ValidatorRegistry.registered?(:string)
      true

      iex> Events.Core.Schema.ValidatorRegistry.registered?(:unknown)
      false
  """
