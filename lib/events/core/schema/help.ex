defmodule Events.Core.Schema.Help do
  @moduledoc """
  ...
  def list_topics do
    ...
    Events.Core.Schema.help(:general)    - Overview and philosophy
    Events.Core.Schema.help(:validators) - Available validators
    Events.Core.Schema.help(:pipelines)  - Pipeline patterns
    Events.Core.Schema.help(:patterns)   - Common patterns
    Events.Core.Schema.help(:examples)   - Complete examples
    """)
  end
