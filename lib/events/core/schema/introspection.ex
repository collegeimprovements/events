defmodule Events.Core.Schema.Introspection do
  @moduledoc """
  Introspection utilities for Events.Core.Schema validations.
  ...
  @doc """
  Generate JSON schema from Events.Core.Schema validations.
  """
