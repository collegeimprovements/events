defmodule Events.Core.Schema.Telemetry do
  @moduledoc """
  Telemetry integration for Events.Core.Schema validation monitoring.
  ...
  defp get_validator_for_type(type) do
    case type do
      ...
      :integer ->
        Events.Core.Schema.Validators.Number
      ...
      :boolean ->
        Events.Core.Schema.Validators.Boolean

      {:array, _} ->
        Events.Core.Schema.Validators.Array

      :map ->
        Events.Core.Schema.Validators.Map

      {:map, _} ->
        Events.Core.Schema.Validators.Map

      type when type in [:date, :time, :naive_datetime, :utc_datetime] ->
        Events.Core.Schema.Validators.DateTime
