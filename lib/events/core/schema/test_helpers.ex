defmodule Events.Core.Schema.TestHelpers do
  @moduledoc """
  Test helpers for Events.Core.Schema validation testing.
  ...
  alias Events.Core.Schema.ValidationPipeline
  ...
  def test_normalization(value, opts) when is_list(opts) do
    Events.Core.Schema.Helpers.Normalizer.normalize(value, opts)
  end

  def test_normalization(value, normalizer) do
    # Wrap non-list normalizers in opts format
    Events.Core.Schema.Helpers.Normalizer.normalize(value, normalize: normalizer)
  end
