defmodule Events.Core.Migration.Help do
  @moduledoc """
  ...
  def list_topics do
    ...
    Events.Core.Migration.help(:general)   - Overview and philosophy
    Events.Core.Migration.help(:pipeline)  - Pipeline functions
    Events.Core.Migration.help(:fields)    - Field helpers
    Events.Core.Migration.help(:indexes)   - Index creation
    Events.Core.Migration.help(:dsl)       - DSL syntax
    Events.Core.Migration.help(:examples)  - Complete examples
    Events.Core.Migration.help(:patterns)  - Common patterns
    """)
  end
  ...
  def general_help do
    ...
    1. Add `use Events.Core.Migration` to your migration module
    2. Choose pipeline or DSL style
    3. Compose your migration using available functions
    4. Execute the migration

    For more help: Events.Core.Migration.help(:examples)
    """)
  end
