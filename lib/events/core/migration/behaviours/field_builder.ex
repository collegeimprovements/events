defmodule Events.Core.Migration.Behaviours.FieldBuilder do
  @moduledoc """
  ...
  ## Implementing a Field Builder
      ...
      defmodule MyApp.Migration.CustomFields do
        @behaviour Events.Core.Migration.Behaviours.FieldBuilder
  ...
  This is the standard way to invoke a field builder:
      ...
      token
      |> FieldBuilder.apply(Events.Core.Migration.FieldBuilders.Timestamps, with_deleted: true)
  """
