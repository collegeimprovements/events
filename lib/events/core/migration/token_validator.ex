defmodule Events.Core.Migration.TokenValidator do
  @moduledoc """
  ...
  Raises `Events.Core.Migration.ValidationError` with detailed error information.
  ...
  def validate!(%Token{} = token) do
    case validate(token) do
      ...
      {:error, errors} ->
        ...
        raise Events.Core.Migration.ValidationError, message: message, errors: errors
    end
  end
...
defmodule Events.Core.Migration.ValidationError do
  @moduledoc """
