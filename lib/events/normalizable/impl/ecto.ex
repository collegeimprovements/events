...
defimpl Events.Normalizable, for: Ecto.MultipleResultsError do
  @moduledoc """
...
defimpl Events.Normalizable, for: Ecto.ConstraintError do
  @moduledoc """
...
defimpl Events.Normalizable, for: Ecto.QueryError do
  @moduledoc """
...
defimpl Events.Normalizable, for: Ecto.CastError do
  @moduledoc """
...
defimpl Events.Normalizable, for: Ecto.InvalidChangesetError do
  @moduledoc """
  ...
  def normalize(%Ecto.InvalidChangesetError{changeset: changeset} = _exception, opts) do
    ...
    Events.Normalizable.normalize(changeset, opts)
  end
end
