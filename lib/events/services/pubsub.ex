defmodule Events.Services.PubSub do
  @moduledoc """
  ...
  ## Usage
      ...
      Events.Services.PubSub.subscribe("room:123")

      # Broadcast to a topic
      Events.Services.PubSub.broadcast("room:123", :new_message, %{text: "Hello"})

      # Or use Phoenix.PubSub directly
      Phoenix.PubSub.broadcast(Events.Services.PubSub.server(), "room:123", {:new_message, payload})
  ...
  Use this when calling Phoenix.PubSub functions directly:
      ...
      Phoenix.PubSub.broadcast(Events.Services.PubSub.server(), "topic", message)
  """
  @spec server() :: atom()
  ...
  ## Examples
      ...
      Events.Services.PubSub.subscribe("room:123")
      Events.Services.PubSub.subscribe("user:\#{user_id}")
  """
  ...
  ## Examples
      ...
      Events.Services.PubSub.unsubscribe("room:123")
  """
  ...
  ## Examples
      ...
      Events.Services.PubSub.broadcast("room:123", :new_message, %{text: "Hello"})
      Events.Services.PubSub.broadcast("user:notifications", :alert, %{level: :warning})
  """
  ...
  ## Examples
      ...
      Events.Services.PubSub.broadcast_from(self(), "room:123", :typing, %{user: "Alice"})
  """
  ...
  ## Examples
      ...
      Events.Services.PubSub.direct_broadcast(node(), "room:123", :ping, %{})
  """
