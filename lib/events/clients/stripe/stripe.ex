defmodule Events.Clients.Stripe do
  @moduledoc """
  ...
  Simple function calls with config as the last argument:
      ...
      config = Stripe.config(api_key: "sk_test_...")

      {:ok, customer} = Stripe.create_customer(%{email: "user@example.com"}, config)
      {:ok, customer} = Stripe.get_customer("cus_123", config)
      {:ok, customers} = Stripe.list_customers([limit: 10], config)
  ...
  ## Configuration
      ...
      # From environment
      config = Stripe.config_from_env()

      # For connected accounts
      config = Stripe.config(api_key: "sk_test_...", connect_account: "acct_123")
  ...
  alias Events.Clients.Stripe.Config
  ...
  ## Examples
      ...
      Stripe.new(config)
      |> Stripe.charges()
      |> Stripe.create(%{amount: 1000, currency: "usd", source: "tok_..."})
  """
  ...
  ## Examples
      ...
      |> Stripe.create(%{amount: 1000, currency: "usd"})
  """
  ...
  ## Examples
      ...
      Stripe.new(config)
      |> Stripe.customers("cus_123")
      |> Stripe.update(%{email: "new@example.com"})
  """
  ...
  ## Examples
      ...
      Stripe.get_customer("cus_123", config)
  """
  ...
  ## Examples
      ...
      Stripe.update_customer("cus_123", %{email: "new@example.com"}, config)
  """
  ...
  ## Examples
      ...
      Stripe.delete_customer("cus_123", config)
  """
  ...
  ## Examples
      ...
      Stripe.list_customers(config)
      Stripe.list_customers(config, limit: 10, email: "user@example.com")
  """
  ...
  ## Examples
      ...
      Stripe.create_charge(%{amount: 1000, currency: "usd", source: "tok_..."}, config)
  """
  ...
  ## Examples
      ...
      Stripe.get_charge("ch_123", config)
  """
  ...
  ## Examples
      ...
      Stripe.create_payment_intent(%{amount: 1000, currency: "usd"}, config)
  """
  ...
  ## Examples
      ...
      Stripe.get_payment_intent("pi_123", config)
  """
  ...
  ## Examples
      ...
      Stripe.confirm_payment_intent("pi_123", config)
      Stripe.confirm_payment_intent("pi_123", config, payment_method: "pm_...")
  """
  ...
  ## Examples
      ...
      Stripe.cancel_payment_intent("pi_123", config)
  """
