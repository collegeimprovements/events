defmodule Events.Credo.Checks.UseDecorator do
  @moduledoc """
  ...
  use Credo.Check,
    ...
    explanations: [
      check: """
      Context and service modules should use `Events.Decorator` for
  ...
  # Check for use Events.Decorator
  ...
  defp check_decorator_usage(acc, issue_meta, _source_file) do
    ...
    [
      format_issue(
        issue_meta,
        message: "Consider using `use Events.Decorator` for type contracts and telemetry.",
        trigger: "defmodule",
        line_no: line,
        priority: :low
      )
